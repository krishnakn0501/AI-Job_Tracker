...
export default function SignupPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-100 dark:bg-neutral-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-[10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-slate-300/40 dark:bg-neutral-800/40 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-slate-200/40 dark:bg-neutral-700/40 blur-[120px] pointer-events-none" />
        ...
        <div className="bg-white/70 dark:bg-black/40 backdrop-blur-xl rounded-2xl shadow-[0_8px_32px_0_rgba(0,0,0,0.05)] border border-white/40 dark:border-white/10 p-8 sm:p-10">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">
              Join JobTrack to track your job applications
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5 group">
              <label htmlFor="confirmPassword" className="text-sm font-semibold text-slate-700 dark:text-slate-300 transition-colors group-focus-within:text-slate-900 dark:group-focus-within:text-white">Confirm Password</label>
              <PasswordInput
                id="confirmPassword"
          ...
          <div className="mt-8 text-center text-sm font-medium text-slate-500 dark:text-slate-400">
            ...
            <Link href="/login" className="text-slate-900 dark:text-white hover:underline decoration-slate-300 dark:decoration-slate-600 underline-offset-4 transition-all">
              Sign in
            </Link>
          </div>
        </div>
