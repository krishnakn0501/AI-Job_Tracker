...
export default function ResetPasswordContent() {
  ...
  return (
    <main className="min-h-screen bg-slate-100 dark:bg-neutral-900 flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute top-[0%] left-[10%] w-[40%] h-[40%] rounded-full bg-slate-300/40 dark:bg-neutral-800/40 blur-[120px] pointer-events-none" />
        ...
        <div className="bg-white/70 dark:bg-black/40 backdrop-blur-xl rounded-2xl shadow-[0_8px_32px_0_rgba(0,0,0,0.05)] border border-white/40 dark:border-white/10 p-8 sm:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5 group">
              <label htmlFor="password" className="text-sm font-semibold text-slate-700 dark:text-slate-300 transition-colors group-focus-within:text-slate-900 dark:group-focus-within:text-white">
                New Password
              </label>
              <PasswordInput
                id="password"
            ...
            <div className="space-y-1.5 group">
              <label htmlFor="confirmPassword" className="text-sm font-semibold text-slate-700 dark:text-slate-300 transition-colors group-focus-within:text-slate-900 dark:group-focus-within:text-white">
